...
class _FileManagerPageState extends State<FileManagerPage> {
  ...
  bool isSystemProtectPath(String targetPath) {
    ...
    for (String safePath in _systemProtectPaths) {
      String lowSafe = safePath.toLowerCase();
      if (absPath.startsWith(lowSafe)) return true;
    }
    return false;
  }
            ...
            child: Column(
              ...
              children: [
                ...
                ListTile(
                  ...
                  trailing: isScanning ? const CircularProgressIndicator() : null,
                  onTap: scanLan,
                ),
                ...lanDevices.map((dev) => ListTile(
